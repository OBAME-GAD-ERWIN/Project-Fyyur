...
def shows():
    ...
    for show in shows:
        data.append({
            ...
            'start_time': format(str(show.start_time))
        })
...
''' Ressourcing: StarkFlow, Youtube, Helpers Fyyur, Fyyur tuto, Bootstrap3, Flask-Migrate, DateTime...'''
'''Format Code: Instruction Fyyur'''